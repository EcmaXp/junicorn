...
public class Sample_x86_mmr {
   ...
   static void test_x86_mmr() throws UnicornException
   {
       ...
       uc.reg_write(Unicorn.UC_X86_REG_LDTR, (long)(Object)ldtr1);
       uc.reg_write(Unicorn.UC_X86_REG_GDTR, (long)(Object)gdtr1);
       uc.reg_write(Unicorn.UC_X86_REG_EAX, (0xdddddddd));
      
       // read the registers back out   
       eax = (int)((long)uc.reg_read(Unicorn.UC_X86_REG_EAX));
       ldtr2 = (X86_MMR)(Object)uc.reg_read(Unicorn.UC_X86_REG_LDTR);
       gdtr2 = (X86_MMR)(Object)uc.reg_read(Unicorn.UC_X86_REG_GDTR);
   ...
   public static void main(String args[]) throws UnicornException
   {
    ...
    private static class X86_MMR
    {
        ...
        public X86_MMR(long l, int i, int i1, short i2)
        {
        }
    }
}
