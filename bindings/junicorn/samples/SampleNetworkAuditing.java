...
import junicorn.InterruptHook;
import junicorn.Unicorn;
import junicorn.UnicornConst;
...
//         System.err.println(String.format("Interrupt 0x%x, from Unicorn 0x%x", intno, u.hashCode()));
    ...
    // utilities
    static String read_string(Unicorn uc, long addr) throws UnicornException
    {
    ...
    static void test_i386(byte[] code)
    {
        ...
        try
        {
            ...
            // initialize stack
            mu.reg_write(Unicorn.UC_X86_REG_ESP, (ADDRESS + 0x200000));

            // handle interrupt ourself
            mu.hook_add(UnicornConst.UC_HOOK_INTR, new MyInterruptHook(), 1, 0, null);
