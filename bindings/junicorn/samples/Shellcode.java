...
public class Shellcode
{
    ...
    public static class MyCodeHook implements CodeHook
    {
        public void hook(Unicorn u, long address, int size, Object user)
        {
            try
            {
                ...
                System.out.print(String.format("*** EIP = %x ***: ", r_eip));
    ...
    static void test_i386() throws UnicornException
    {
        ...
        u.hook_add(UnicornConst.UC_HOOK_CODE, new MyCodeHook(), 1, 0, null);

        // handle interrupt ourself
        u.hook_add(UnicornConst.UC_HOOK_INTR, new MyInterruptHook(), 1, 0, null);
